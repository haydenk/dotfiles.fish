...
alias ..... 'cd ../../../..'
alias ...... 'cd ../../../../..'
alias l='eza --icons --long --all --header --git --no-permissions --no-time --no-user --no-filesize --group-directories-first'
alias ll='eza --icons -lgh --git --group-directories-first'
alias la='eza --icons -lagh --git --group-directories-first --sort modified'
alias cll='clear; and eza --icons --long --all --header --git --no-permissions --no-time --no-user --no-filesize --group-directories-first'
